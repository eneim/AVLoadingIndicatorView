...
public class SquareSpinIndicator extends BaseIndicatorController {
  ...
  public void draw(Canvas canvas, Paint paint) {
    ...
    canvas.drawRect(new RectF(getWidth() / 5, getHeight() * 3 / 5, getWidth() * 4 / 5, getHeight() *
        4 / 5), paint);
  ...
  public void createAnimation() {
        /*ObjectAnimator rotationXAnimation=ObjectAnimator.ofFloat(getTarget(), "rotationX",0,
        180,180,0,0);
        rotationXAnimation.setDuration(3000);

        ObjectAnimator rotationYAnimation=ObjectAnimator.ofFloat(getTarget(), "rotationY",0,0,
        180,180,0);
